...
tbb::concurrent_vector<uint32_t> *tempEntries = &(testMutex.tempEntries);
...
void VM::interpretCases()
{
    ...
    DO_CASES
    {
	    ...
	    cout << "key" << m_SP[0] << "value" << m_SP[1] << "unmutex sstore" << endl;
        }
        NEXT
...
void VM::mutexCases()
{
    //my_mutex_t::scoped_lock my_lock{*my_mutex_2}
    //INIT_CASES
    {
    my_mutex_t::scoped_lock my_lock{*my_mutex_2};
    tempEntries->push_back(m_ID);
//        std::cout << "te" << m_ID << endl;
    INIT_CASES
            DO_CASES
            {
                    //
    ...
    if (m_SP[1])
        ...
        ++m_PC;
			...
			cout << "key" << m_SP[0] << "value" << m_SP[1] << "mutex sstore" << endl;
                    }
                    NEXT
