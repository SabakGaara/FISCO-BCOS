...
namespace dev
{
    namespace blockverifier
    {
        ...
        {
        public:
            tbb::concurrent_vector<ID> TxSequence;
            TxDAG() : m_dag() {}
            virtual ~TxDAG() {}
            ...
            void verifyInit(ExecutiveContext::Ptr _ctx, std::shared_ptr<dev::eth::Transactions> _txs,
                      int64_t _blockHeight);
        ...
        public:
            ...
            std::vector<unsigned int> get(T const& _c)
            {
...
//                return m_criticalAll;
                ...
                //auto res = std::make_shared<std::vector<ID>>();
                //res = &(m_criticals[_c]);
                return it->second;
            }
            ...
            {
                m_criticals[_c].push_back(_txId);
            }
        private:
